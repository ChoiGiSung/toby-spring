...
public class UserLevelDefaultPolicy implements UserLevelUpgradePolicy {
    ...
    public boolean canUpgradeLevel(User user) {
        ...
        switch (level){
            case BASIC:return (user.getLogin() >= UserServiceImpl.MIN_LOG_COUNT_FOR_SILVER);
            case SILVER:return (user.getRecommend() >= UserServiceImpl.MIN_RECCOMEND_COUNT_FOR_GOLD);
